    ...
    Array.from(slides).every(slide => {
      if (!spec.vertical) {
        if (
          ...
          spec.swipeLeft * -1 && spec.swipeLeft * -1 < slides[slides.length - 1].offsetLeft
        ) {
          swipedSlide = slide;
          return false;
        }
        else if (spec.swipeLeft * -1 > slides[slides.length - 1].offsetLeft) {
          swipedSlide = slides[slides.length - 1];
          return false;
        }
      } else {
